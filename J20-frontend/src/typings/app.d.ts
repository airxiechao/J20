        ...
        detection: {
          rule: {
            ...
            form: {
              ...
              protocol: string;
              outputEventTypeId: string;
              addCriteriaFileterNodeGroup: string;
              addCriteriaFileterNodeField: string;
              criteriaFilterNodeField: string;
              criteriaFilterNodeValue: string;
              windowUnit: string;
              windowSize: string;
              groupBy: string;
              field: string;
